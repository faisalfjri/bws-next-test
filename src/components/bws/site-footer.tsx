...
export function SiteFooter() {
  return (
    <footer className="bg-white border-t border-gray-100">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-8 sm:py-10 grid gap-6 sm:gap-8 sm:grid-cols-3">
        <div>
        ...
        <div>
          ...
          <div className="mt-3 space-y-2 text-sm">
            ...
            <Link href="/articles" className="block text-gray-600 hover:text-gray-900">Semua Berita</Link>
            <Link href="/lokasi-kantor" className="block text-gray-600 hover:text-gray-900">Lokasi Kantor</Link>
          </div>
        </div>
        <div>
      ...
      <div className="border-t border-gray-100">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-4 text-[11px] text-gray-400">
